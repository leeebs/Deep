...
import pathlib
import os
from configuration import IMAGE_HEIGHT, IMAGE_WIDTH, CHANNELS, BATCH_SIZE, train_tfrecord, valid_tfrecord, test_tfrecord
...
def get_images_and_labels(data_root_dir):
    ...
    all_image_label = [label_to_index[pathlib.Path(single_image_path).parent.name]
