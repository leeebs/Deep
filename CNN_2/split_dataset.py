...
class SplitDataset():
    ...
    def get_all_file_path(self):
        all_file_path = []
        index = 0
        for file_type in self.get_label_names():
    ...
    def copy_files(self, type_path, type_saved_dir):
...
if __name__ == "__main__":
    split_dataset = SplitDataset(dataset_dir="tfrecord\\original_dataset", 
                                saved_dataset_dir="tfrecord\\dataset",
                                show_progress=True)
